...
## Protoboard
Es una placa que permite realizar conexiones rápidas y sin soldadura, gracias a una serie de orificios conectados entre sí internamente. Se compone principalmente de tres partes: los buses de alimentación, el canal central y las pistas de conexión.
...
- ### Buses de alimentación
    ...
    *Imagen 2. Bus de alimentación negativo de la protoboard.*

- ### Canal central
    Separa las dos secciones principales de la protoboard. Este espacio permite insertar circuitos integrados (ICs) u otros componentes de tal forma que sus pines queden conectados a las pistas de cada lado, evitando cortocircuitos entre ellos.
...
## LEDs
Los LED (Light Emitting Diodes) son componentes electrónicos que emiten luz cuando una corriente eléctrica pasa a través de ellos. A diferencia de las bombillas incandescentes, los LEDs son más eficientes energéticamente, duran más tiempo y son más pequeños.
...
*Imagen 11. Tabla para calcular el valor de una resistencia.*
